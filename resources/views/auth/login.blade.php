	...
	<body class="font-poppins text-[#0E0140]">
		<main class="min-h-dvh">
			...
			<section id="right-side" class="w-dvw h-dvh flex flex-col items-center justify-center pl-[640px] py-[140px]">
				<a href="{{ route('home.index') }}" class="flex shrink-0 justify-start w-[500px] h-[10] mb-[70px]">
				...
				<form id="form-signin" method="POST" action="{{ route('login') }}" class="w-[500px] flex flex-col gap-[30px]">
					...
					<div class="flex flex-col gap-2">
						...
						<div class="flex items-center rounded-full py-[14px] px-[24px] gap-[10px] ring-1 ring-[#0E0140] focus-within:ring-2 focus-within:ring-[#FF6B2C] transition-all duration-300">
							...
							<input type="email" name="email" id="email" class="w-full focus:outline-none font-semibold placeholder:font-normal placeholder:text-[#0E0140]" placeholder="Write your email address" required />
						</div>
					</div>
					<div class="flex flex-col gap-2">
						...
						<div class="flex items-center rounded-full py-[14px] px-[24px] gap-[10px] ring-1 ring-[#0E0140] focus-within:ring-2 focus-within:ring-[#FF6B2C] transition-all duration-300">
							...
							<input type="password" name="password" id="password" class="w-full focus:outline-none font-semibold placeholder:font-normal placeholder:text-[#0E0140]" placeholder="Write your password" required />
						</div>
