    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <div class="item-card flex flex-row gap-y-10 justify-between md:items-center">
                    ...
                    <div class="hidden md:flex flex-col">
                        ...
                        <h3 class="text-indigo-950 text-xl font-bold">
                            {{ number_format($jobCandidate->job->salary, 0, ',', '.') }} /mo
                        </h3>
                    </div>
                    <div class="hidden md:flex flex-col">
                ...
                @if($jobCandidate->candidate_id == Auth::user()->id && $jobCandidate->is_hired && 
                !$jobCandidate->job->is_open) 
                    <hr class="my-5">
                ...
                @elseif($jobCandidate->candidate_id == Auth::user()->id && !$jobCandidate->is_hired && 
                !$jobCandidate->job->is_open)
                        <hr class="my-5">
