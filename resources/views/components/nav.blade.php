<nav class="container max-w-[1130px] mx-auto flex items-center justify-between pt-10">
    ...
    <ul class="flex items-center gap-10">
        <li>
            <a href="{{ route('home.index') }}" class="transition-all duration-300 hover:font-semibold hover:text-[#FF6B2C] {{ request()->routeIs('home.index') ? 'font-semibold text-[#FF6B2C]'  : 'text-white' }}">Home</a>
        </li>
        <li>
